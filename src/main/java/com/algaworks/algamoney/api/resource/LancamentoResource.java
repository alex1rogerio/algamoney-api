...
public class LancamentoResource {
	...
	@ExceptionHandler({LancamentoInexistenteOuInativaException.class})
	public ResponseEntity<Object> handleLancamentoInexistenteOuInativaException(LancamentoInexistenteOuInativaException ex){	
